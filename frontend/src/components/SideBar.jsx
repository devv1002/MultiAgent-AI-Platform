...
import { Coins, PanelLeftIcon, PanelRight, PenSquare, Plus, MessageSquare, User, LogOut, Menu } from "lucide-react"
...
function SideBar() {
  ...
  return (
    <div className='fixed lg:static inset-y-0 left-0 z-50 w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/6'>
